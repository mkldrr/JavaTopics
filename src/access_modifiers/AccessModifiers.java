...
//
//    Default – No keyword required: only within the same package whenever we don’t mention./   scope: only within the package
...
//    Public : public are accessible from every where in the program, within the project. 
